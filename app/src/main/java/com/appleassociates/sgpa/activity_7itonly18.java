...
public class activity_7itonly18 extends AppCompatActivity {

    EditText btn71 , btn72, btn73, btn74, btn75, btn76, btn77;
        ...
        show4.setOnClickListener(v -> {
            try {
                if (validateFields()) {
                    ...
                    Toast.makeText(activity_7itonly18.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void calculate() {
        try {
            ...
            if (m71 >= 0 && m71 <= 100 &&
                ...
                double total = calculateSGPAGrades(m71Grade, m72Grade, m73Grade, m74Grade, m75Grade, m76Grade, m77Grade);
                ...
                Toast.makeText(activity_7itonly18.this, "Please enter valid marks (0-100)", Toast.LENGTH_SHORT).show();
            }
        } catch (NumberFormatException e) {
            Toast.makeText(activity_7itonly18.this, "Please enter valid numeric values", Toast.LENGTH_SHORT).show();
    ...
    private double calculateSGPAGrades(int m71Grade, int m72Grade, int m73Grade, int m74Grade, int m75Grade, int m76Grade, int m77Grade) {
        ...
        int totalCP = m71CP + m72CP + m73CP + m74CP + m75CP + m76CP + m77CP  ;
        int totalCredits = m71Credits + m72Credits + m73Credits + m74Credits + m75Credits + m76Credits + m77Credits;
