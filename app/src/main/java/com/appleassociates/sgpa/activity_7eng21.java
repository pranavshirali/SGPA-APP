...
public class activity_7eng21 extends AppCompatActivity {

    EditText btn71 ,btn72, btn73, btn74, btn75, btn76;
    TextView result7, startingTextView;
    Button show;
    @SuppressLint("SetTextI18n")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_7eng21);
        ...
        startingTextView.setText("2021 SCHEME / 7TH SEM / " + getString(R.string.selected_option) + selectedOption);
        ...
        show.setOnClickListener(v -> {
            ...
            try {
                if (validateFields()) {
                    ...
                    Toast.makeText(activity_7eng21.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void calculate() {
        try {
            ...
            if (m71 >= 0 && m71 <= 100 &&
                ...
                double total = calculateSGPAGrades(m71Grade, m72Grade, m73Grade, m74Grade, m75Grade, m76Grade);
                ...
                Toast.makeText(activity_7eng21.this, "Please enter valid marks (0-100)", Toast.LENGTH_SHORT).show();
            }
        } catch (NumberFormatException e) {
            Toast.makeText(activity_7eng21.this, "Please enter valid numeric values", Toast.LENGTH_SHORT).show();
    ...
    private double calculateSGPAGrades(int m71Grade, int m72Grade, int m73Grade, int m74Grade, int m75Grade, int m76Grade) {
        ...
        int totalCP = m71CP + m72CP + m73CP + m74CP + m75CP + m76CP ;
        int totalCredits = m71Credits + m72Credits + m73Credits + m74Credits + m75Credits + m76Credits;
