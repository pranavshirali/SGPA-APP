...
public class activity_3cse21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_3cse21);
        ...
        show.setOnClickListener(v -> {
            ...
            try {
                if (validateFields()) {
                    ...
                    Toast.makeText(activity_3cse21.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void calculate() {
        try {
            ...
            if (math >= 0 && math <= 100 &&
                ...
                Toast.makeText(activity_3cse21.this, "Please enter valid marks (0-100)", Toast.LENGTH_SHORT).show();
            }
        } catch (NumberFormatException e) {
            Toast.makeText(activity_3cse21.this, "Please enter valid numeric values", Toast.LENGTH_SHORT).show();
