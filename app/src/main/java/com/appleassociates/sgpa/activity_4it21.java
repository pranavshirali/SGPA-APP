...
public class activity_4it21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_4it21);
        ...
        show.setOnClickListener(v -> {
            ...
            try {
                if (validateFields()) {
                    ...
                    Toast.makeText(activity_4it21.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void calculate() {
        try {
            ...
            if (cs41 >= 0 && cs41 <= 100 &&
                ...
                Toast.makeText(activity_4it21.this, "Please enter valid marks (0-100)", Toast.LENGTH_SHORT).show();
            }
        } catch (NumberFormatException e) {
            Toast.makeText(activity_4it21.this, "Please enter valid numeric values", Toast.LENGTH_SHORT).show();
